<h2 class="login-register-login-title">{{translate 'Trade Login'}}</h2>
<p class="login-register-login-description">
	...
	{{else}}
		{{translate 'Login below to checkout with an existing account or contact your account manager to request access'}}
	{{/if}}
</p>
...
<form class="login-register-login-form" novalidate>
	<fieldset class="login-register-login-form-fieldset">
		...
		<div class="login-register-login-form-controls-group button" data-type="form-login-action">
