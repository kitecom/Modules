<section class="facets-facet-browse">
	<div data-cms-area="item_list_banner" data-cms-area-filters="path"></div>
	...
	{{#if showResults}}
		<div class="facets-facet-browse-content">
			...
			<div class="facets-facet-browse-facets" data-action="pushable" data-id="product-search-facets">
				...
				<div class="facet-navigation-top"><h2>Trade Store</h2></div>

				<!--h3 class="facet-navigation-header">Filter Things<i class="icon-sliders"></i></h3-->
				...
				<div data-cms-area="facet_navigation_bottom" data-cms-area-filters="path"></div>
			</div>
		...
		<div class="facets-facet-browse-cms-area-2" data-cms-area="facets_facet_browse_cms_area_2" data-cms-area-filters="path"></div>
