<a class="header-profile-login-link" data-touchpoint="login" data-hashtag="login-register" href="my_account">
...
{{#if showExtendedMenu}}
	<a class="header-profile-welcome-link" href="#" data-toggle="dropdown">
		...
		{{translate 'Welcome <span class="header-profile-welcome-link-name">$(0)</span>' displayName}}
